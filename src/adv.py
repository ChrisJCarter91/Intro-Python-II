...
room = {
    ...
    'treasure': Room("Treasure Chamber", "You've found the long-lost treasure chamber! Sadly, it has already been completely emptied by earlier adventurers. The only exit is to the south.",["cloak"]),
}

# Declare items

items = {
    "sword": Item("+1 Short Sword", "A sword with a faint blue glow"),

    "ring": Item("Ring of Protection", "A ring that adds +1 to armor class and saving throws"),

    "cloak": Item("Cloak of Invisibility", "This cloak shimmers on one side and can't be seen from the other. Offers invisibility")
}
